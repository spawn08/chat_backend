...
from spawn_ai.components import ComponentBuilder
from spawn_ai.config import RasaNLUModelConfig
from spawn_ai.emulators import NoEmulator
from spawn_ai.evaluate import run_evaluation
from spawn_ai.model import InvalidProjectError
from spawn_ai.project import (
    Project, STATUS_FAILED, STATUS_READY, STATUS_TRAINING, load_from_server)
from spawn_ai.train import do_train_in_worker
...
class DataRouter(object):
    ...
    def _list_projects_in_cloud(self) -> List[Text]:
        ...
        try:
            from spawn_ai.persistor import get_persistor
    ...
    def _create_emulator(mode: Optional[Text]) -> NoEmulator:
        ...
        if mode is None:
            ...
            from spawn_ai.emulators.wit import WitEmulator
            return WitEmulator()
        elif mode.lower() == 'luis':
            from spawn_ai.emulators.luis import LUISEmulator
            return LUISEmulator()
        elif mode.lower() == 'dialogflow':
            from spawn_ai.emulators.dialogflow import DialogflowEmulator
