...
from spawn_ai.training_data.util import check_duplicate_synonym
from spawn_ai.utils import lazyproperty, list_to_str, write_to_file
...
class TrainingData(object):
    ...
    def as_json(self, **kwargs: Any) -> Text:
        ...
        from spawn_ai.training_data.formats import RasaWriter
        return RasaWriter().dumps(self)

    def as_markdown(self) -> Text:
        """Generates the markdown representation of the TrainingData."""
        from spawn_ai.training_data.formats import MarkdownWriter
