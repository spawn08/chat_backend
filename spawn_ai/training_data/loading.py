...
from spawn_ai.training_data.formats import markdown
from spawn_ai.training_data.formats.dialogflow import (
...
from spawn_ai.utils import EndpointConfig
...
def _reader_factory(fformat):
    ...
    from spawn_ai.training_data.formats import (
