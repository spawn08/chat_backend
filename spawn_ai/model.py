...
import spawn_ai
from spawn_ai import components, utils, config
from spawn_ai.components import Component, ComponentBuilder
from spawn_ai.config import RasaNLUModelConfig
from spawn_ai.persistor import Persistor
from spawn_ai.training_data import TrainingData, Message
from spawn_ai.utils import create_dir, write_json_to_file
...
class Metadata(object):
    ...
    def persist(self, model_dir: Text):
        ...
        metadata.update({
            ...
            "rasa_nlu_version": spawn_ai.__version__,
        })
    ...
    def ensure_model_compatibility(metadata: Metadata,
        ...
        if version.parse(model_version) < version.parse(version_to_check):
            raise UnsupportedModelError(
                ...
                "".format(model_version, spawn_ai.__version__))
