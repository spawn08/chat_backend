...
from spawn_ai.data_router import (
    DataRouter, InvalidProjectError,
    MaxTrainingError)
from spawn_ai.model import MINIMUM_COMPATIBLE_VERSION
...
def create_argument_parser():
    ...
    parser.add_argument('--pre_load',
                        ...
                        help='Preload models into memory before starting the '
                             ...
                             'spawn_ai.server --pre_load project1 '
                             '--path projects '
                             '-c config.yaml')
    ...
    parser.add_argument('-c', '--config',
                        default="/opt/config/spawn_config.yml",
